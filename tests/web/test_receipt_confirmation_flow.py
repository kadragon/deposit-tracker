...
def test_should_display_parsed_receipt_for_confirmation():
    ...
    response = client.get('/confirm-receipt?store_name=Test Store&total=5000&items=Item1:2000,Item2:3000')
...
def test_should_allow_user_to_select_target_user():
    ...
    response = client.get('/confirm-receipt?store_name=Test Store&total=5000')
